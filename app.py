...
URL = "https://the-flicker3-wyqfoj2l7a-ew.a.run.app/"
...
def sentimental_analysis_plot(sentiment_dict, title):
    ...
    fig = plt.figure(figsize=(10, 10), linewidth=10, edgecolor='#393d5c', facecolor='#000000')
    fig.suptitle(f"SENTIMENT ANALYSIS FOR '{title.upper()}'", fontsize=20, fontweight='bold', color='white')
    ...
    ax_polar.set_rgrids([0, 1, 2, 3, 4, 5], labels=ring_labels, angle=0, fontsize=14, fontweight='bold', color='white', verticalalignment='center')
